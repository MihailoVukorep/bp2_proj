...
CREATE TABLE Equipment 
    ( 
     ...
     Soldier_s_id         NUMBER , 
     Storage_bs_id        NUMBER 
    ) 
;

ALTER TABLE Equipment 
    ADD CONSTRAINT Equipment_PK PRIMARY KEY ( e_id ) ;
...
CREATE TABLE Medal 
    ( 
     ...
     Medal_Type_mt_id   NUMBER  NOT NULL , 
     award_date         DATE , 
...
ALTER TABLE Medal 
    ADD CONSTRAINT Medal_PK PRIMARY KEY ( Medal_Type_mt_id, Participation_p_id ) ;
...
ALTER TABLE Medal_Type 
    ADD CONSTRAINT Medal_Type_PK PRIMARY KEY ( mt_id ) ;
...
;
CREATE UNIQUE INDEX Mission__IDX ON Mission 
    ( 
     Location_l_id ASC 
    ) 
;
...
ALTER TABLE Mission 
    ADD CONSTRAINT Mission_PK PRIMARY KEY ( mis_id ) ;
...
ALTER TABLE Participation 
    ADD CONSTRAINT Participation_PK PRIMARY KEY ( p_id ) ;
...
ALTER TABLE Soldier 
    ADD CONSTRAINT Soldier_PK PRIMARY KEY ( s_id ) ;
...
ALTER TABLE specializing 
    ADD CONSTRAINT specializing_PK PRIMARY KEY ( Specialty_s_id, Soldier_s_id ) ;
...
ALTER TABLE Vehicle 
    ADD CONSTRAINT Vehicle_PK PRIMARY KEY ( v_id ) ;
...
ALTER TABLE Equipment 
    ADD CONSTRAINT Equipment_Soldier_FK FOREIGN KEY 
    ( 
     Soldier_s_id
    ) 
    REFERENCES Soldier 
